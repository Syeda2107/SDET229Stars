...
public class DSIntroductionSteps {
    ...
    public void the_page_url_should_be_displayed_as(String string) {

    }

    @Then("page url should be displayed as {string}")
    public void page_url_should_be_displayed_as(String string) {

    }

    @When("the user enters \"print \"Hello\"\"")
    public void the_user_enters_print_hello() {
    ...
    public void the_user_should_get_output_as_below_run_button(String string) {

    }

    @When("the user enters {string} print {string}{string}")
    public void the_user_enters_print(String string, String string2, String string3) {

    }

    @Then("the user should get pop up message as {string}")
    public void the_user_should_get_pop_up_message_as(String string) {
    ...
    @Then("the user should get success message as {string}")
    public void the_user_should_get_success_message_as(String string) {
